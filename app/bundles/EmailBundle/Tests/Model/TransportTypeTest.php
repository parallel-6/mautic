...
class TransportTypeTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testAmazonApiService()
    {
        $transportType = new TransportType();

        $expected = '"mautic.transport.amazon_api"';

        $this->assertSame($expected, $transportType->getAmazonApiService());
    }
    ...
    public function testRequiresLogin()
    {
        ...
        $expected = '"mautic.transport.mailjet","mautic.transport.sendgrid","mautic.transport.elasticemail","mautic.transport.amazon","mautic.transport.amazon_api","mautic.transport.postmark","gmail"';
